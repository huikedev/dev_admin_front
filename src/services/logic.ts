...
export async function getModuleList(
  params: object,
): Promise<AppResponseType<AppPaginator<API.ModuleItem>>> {
...
// 提交 刷新模块路由配置文件
export async function setRefreshRoutes(params: object): Promise<AppResponseType> {
  return request(Apis.module.refreshRoutes, {
    method: 'POST',
    data: params,
  });
}
...
// 提交 刷新模块异常配置文件
export async function setRefreshException(params: object): Promise<AppResponseType> {
  return request(Apis.module.refreshException, {
    method: 'POST',
    data: params,
  });
}
...
// 获取 控制器列表
export async function getControllersList(
  params: object,
): Promise<AppResponseType<AppPaginator<API.ControllerTableItem>>> {
...
// 获取 未同步的控制器列表
export async function getUnSyncedControllers(): Promise<
  AppResponseType<API.UnSyncedControllerItem>
> {
...
// 提交 同步控制器
export async function getControllersSimpleList(
  params: object,
): Promise<AppResponseType<API.ControllerSimpleItem[]>> {
...
// 查询 异常码是否重复
export async function queryCheckException(params: {
  type: 'code' | 'key';
  value: string | number;
}): Promise<AppResponseType<{ result: boolean; type: 'code' | 'key' }>> {
...
// 获取 控制器目录简单列表
export async function getControllerPathSimpleList(): Promise<
  AppResponseType<API.ControllerPathSimpleItem[]>
> {
  return request(Apis.controllerPath.simpleList);
}

// 获取 控制器目录列表
export async function getControllerPathList(
  params: object,
): Promise<AppResponseType<AppPaginator<API.ControllerTableItem>>> {
...
// 提交 创建控制器方法
export async function setActionCreate(
  params: object,
): Promise<AppResponseType<API.ActionCreateResult[] | []>> {
...
// 获取 未同步的控制器方法列表
export async function getUnSyncedAction(
  params: object,
): Promise<AppResponseType<AppPaginator<API.UnSyncedActionItem>>> {
